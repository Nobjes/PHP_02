  ...
  <div class="ranking">
   <fieldset>
    <legend><h2>ランキング登録</h2></legend>
     ...
     <label>　最寄駅：<input type="text" name="first_place"></label><br>
     <label>２位：<input type="text" name="second"></label>
     <label>　最寄駅：<input type="text" name="second_place"></label><br>
     <label>３位：<input type="text" name="third"></label>
     <label>　最寄駅：<input type="text" name="third_place"></label><br>
     <label>４位：<input type="text" name="fourth"></label></label>
     <label>　最寄駅：<input type="text" name="fourth_place"></label><br>
     <label>５位：<input type="text" name="fifth"></label></label>
     <label>　最寄駅：<input type="text" name="fifth_place"></label><br><br>
